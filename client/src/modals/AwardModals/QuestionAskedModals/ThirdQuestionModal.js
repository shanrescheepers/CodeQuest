...
const ThirdQuestionModal = (props) => {
    ...
    return (  
        <div className='overlay'>
            <div className='modal-con'>
                ...
                <img className='award-modal-img' src={image} alt='third question image'/>

                <h1>10th Post</h1>
                <p>Yay! You just posted your tenth question on CodeQuest.</p>
...
export default ThirdQuestionModal;