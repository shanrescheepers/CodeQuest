    ...
    return (  
        <div className='overlay'>
            <div className='modal-con'>
                ...
                <h1>Copper Ball of Yarn</h1>
                <p>Congratulations! You’ve earned a copper ball of yarn for all your hard work, keep it up!</p>
...
export default CopperRankModal;